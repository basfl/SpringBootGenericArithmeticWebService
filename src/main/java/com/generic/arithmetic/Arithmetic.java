...
public class Arithmetic {
	...
	/*
	 * Adds two whole binary, octal, decimal, or hexadecimal numbers of a common
	...
	/*
	 * Subtracts two whole binary, octal, decimal, or hexadecimal numbers of a
	 * common base, and returns a result in the same base as a string.
	 */
	...
	/*
	 * Subtracts two floating point (decimal-based) numbers, and returns a floating
	...
	/*
	 * Multiplies two whole binary, octal, decimal, or hexadecimal numbers of a
	 * common base, and returns a result in the same base as a string.
	 */
	...
	/*
	 * Multiplies two floating point (decimal-based) numbers, and returns a floating
	 * point value as a string.
	 */
	...
	/*
	 * Divides two whole binary, octal, decimal, or hexadecimal numbers of a common
	 * base, and returns a result in the same base as a string. Note that the result
	...
	/*
	 * Divides two floating point (decimal-based) numbers, and returns a floating
	 * point value as a string.
	 */
	...
	/*
	 * Determines the square root of a binary, octal, decimal, or hexadecimal
	 * number, and returns a result in the same base as a string. Note that the
	 * result can only be a whole number.
	 */
	...
	/*
	 * Determines the square root of a floating point (decimal-based) number, and
	 * returns a floating point value as a string.
	 */
	...
	/*
	 * Determines the exponential value of a binary, octal, decimal, or hexadecimal
	 * number raised to a power in the same base, and returns result in the same
	 * base as a string.
	 */
	...
	/*
	 * Determines the exponential value of a floating point (decimal-based) number
	 * raised to a floating point power, and returns a floating point value as a
	 * string.
	 */
	...
	// Check base input to ensure binary(2), octal(8), decimal(10), or
	// hexadecimal(16).
	...
	private static boolean argCheck(int base, String arg) {
		...
		if (len > 1 && arg.charAt(0) == '0')
			return false;
		return true;
	}

	// Check string input to ensure that it parses as a floating point number
	// (decimal-based).
